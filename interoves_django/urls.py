...
urlpatterns = [
    ...
    path('privacy-policy/', RedirectView.as_view(url='/privacy/', permanent=True, query_string=True)),
    path('terms-of-use/', RedirectView.as_view(url='/terms/', permanent=True, query_string=True)),
    path('tickets/', RedirectView.as_view(url='/pay/', permanent=True), name='legacy_tickets'),
    path('ticket-agreement/', RedirectView.as_view(url='/terms/russia/', permanent=True, query_string=True)),
