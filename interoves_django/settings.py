...
MIDDLEWARE = [
    ...
    'games.middleware.auth_session_observability.AuthenticatedRequestAuditMiddleware',
...
TRIBUTE_CLUB_SUBSCRIPTION_RUB_FIRST_AMOUNT = (
    os.environ.get('TRIBUTE_CLUB_SUBSCRIPTION_RUB_FIRST_AMOUNT') or '42000'
).strip()
TRIBUTE_CLUB_SUBSCRIPTION_RUB_YEARLY_AMOUNT = (
    os.environ.get('TRIBUTE_CLUB_SUBSCRIPTION_RUB_YEARLY_AMOUNT') or '600000'
).strip()
# International Tribute plan: €5.55/mo (promo €3.89 first month) or €58/year.
...
TRIBUTE_CLUB_SUBSCRIPTION_EUR_AMOUNT = (os.environ.get('TRIBUTE_CLUB_SUBSCRIPTION_EUR_AMOUNT') or '555').strip()
TRIBUTE_CLUB_SUBSCRIPTION_EUR_FIRST_AMOUNT = (
    os.environ.get('TRIBUTE_CLUB_SUBSCRIPTION_EUR_FIRST_AMOUNT') or '389'
).strip()
TRIBUTE_CLUB_SUBSCRIPTION_EUR_YEARLY_AMOUNT = (
    os.environ.get('TRIBUTE_CLUB_SUBSCRIPTION_EUR_YEARLY_AMOUNT') or '5800'
).strip()
