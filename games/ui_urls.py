...
urlpatterns = [
    ...
    re_path(r'^' + _PROJECT_ID_RE + r'/games/(?P<game_id>[a-zA-Z0-9_]+)/(?P<task_group_number>\d+(?:\.\d+)?)/timing/$', ui.daily_solve_timing, name='project_game_timing'),
    ...
    path('games/<str:game_id>/<str:task_group_number>/timing/', ui.daily_solve_timing, name='ui_game_timing'),
