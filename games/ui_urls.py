...
urlpatterns = [
    ...
    path('create_alphabetty/<int:offer_id>/', ui.offer_alphabetty_detail, name='ui_create_alphabetty_detail'),
    path('create_alphabetty/<int:offer_id>/send/', ui.offer_alphabetty_send, name='ui_create_alphabetty_send'),
    path('create_alphabetty/<int:offer_id>/reopen/', ui.offer_alphabetty_reopen, name='ui_create_alphabetty_reopen'),
