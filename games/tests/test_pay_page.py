...
class PayPageGatingTests(TestCase):
    ...
    def test_anonymous_sees_public_checkout_and_login_gate(self):
        ...
        self.assertIn('new-pay-method--primary', body)
        self.assertEqual(body.count('name="payment_method"'), 3)
        self.assertNotIn('Для карт банков Армении и других стран', body)
