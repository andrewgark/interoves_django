...
urlpatterns = [
    ...
    path('offer_ladder/', ui.offer_ladder_page, name='new_offer_ladder'),
    path('offer_ladder/create/', ui.offer_ladder_create, name='new_offer_ladder_create'),
    path('offer_ladder/<int:offer_id>/', ui.offer_ladder_detail, name='new_offer_ladder_detail'),
    path('offer_ladder/<int:offer_id>/send/', ui.offer_ladder_send, name='new_offer_ladder_send'),
    path('offer_ladder/<int:offer_id>/reset/', ui.offer_ladder_reset, name='new_offer_ladder_reset'),
