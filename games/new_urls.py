...
urlpatterns = [
    path('daily-statistics/<str:game_id>/<str:number>/', ui.daily_statistics, name='new_daily_statistics'),
    ...
    path('games/<str:game_id>/<str:task_group_number>/timing/', ui.daily_solve_timing, name='new_game_timing'),
    ...
    path(
        'subscription/yookassa/monthly/',
        ui.subscription_yookassa_monthly_start,
    ...
    path(
        'subscription/yookassa/resume/',
        ui.subscription_yookassa_resume,
        name='new_subscription_yookassa_resume',
    ),
