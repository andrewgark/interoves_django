...
REVIEWS = [
    ...
    {
        'name': 'Валентина Наврузова',
        'caption': 'внутренние коммуникации, GlowByte',
        'text': (
            'Заказываем «Десяточку» для сотрудников уже в 11 раз - стало нашей корпоративной традицией, два раза в год. '
            'Игра реально сложная, интеллектуальная, заставляет команду думать и спорить в хорошем смысле - '
            'участники после каждой игры делятся впечатлениями в общем чате еще пару дней. '
            'Организация всегда четкая: ни разу не было накладок, все продумано до мелочей. '
            'Продолжаем сотрудничать и не планируем останавливаться.'
        ),
        'is_important': True,
    },
]
