# Правила: попытки включают имена собственные.
...
<p class="pal-lead">
  ...
  Как валидную попытку принимается любое слово из словаря — в том числе имена собственные (имена, фамилии, топонимы).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('games', '0157_alphabetty_dict_suggestion'),
    ]
