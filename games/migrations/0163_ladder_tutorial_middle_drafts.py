# Туториал лесенки: правило про проверку только крайних из неизвестных
# (центральные можно заполнять как черновик).
...
<p class="pal-lead">
  Проверяются на правильность только первое и последнее слова из ещё неизвестных.
  Центральные слова можно записывать для удобства, но проверятся они только тогда,
  когда станут крайними.
</p>
<p class="pal-lead">
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('games', '0162_ticketrequest_tribute_id'),
    ]
