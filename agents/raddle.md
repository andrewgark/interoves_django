...
10. **Sticky при скролле вниз** — пара под шапкой, клавиатура открыта: пин виден,
...
11. **Слова выше пары** — проскроллить к более ранним словам: пина нет (нет задвоения).
12. **Закрытие клавиатуры** — начать ввод, Android Back: клавиатура сама не
    открывается от scroll/viewport; async-ответ не возвращает её, если сессию
    уже сняли.
13. **Back во время запроса** — закрыть клавиатуру до ответа wrong/correct:
